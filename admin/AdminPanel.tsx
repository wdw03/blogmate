...
const AdminPanel: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-[#f1f5f9] dark:bg-slate-950 flex flex-col lg:flex-row overflow-hidden font-['Inter'] transition-colors duration-300">
      ...
      <main className="flex-1 overflow-y-auto relative min-h-[100dvh] lg:h-screen custom-scrollbar bg-[#f8fafc] dark:bg-slate-950 min-w-0 w-full">
        <header className="bg-white/70 dark:bg-slate-900/70 backdrop-blur-xl border-b border-slate-200 dark:border-slate-800 px-6 lg:px-10 py-6 flex items-center justify-between sticky top-0 z-[100] shadow-sm transition-colors duration-300">
          <div className="flex items-center gap-6">
            <h1 className="text-2xl font-black text-slate-900 dark:text-slate-100 uppercase tracking-tighter italic transition-colors duration-300">{activeTab}</h1>
          ...
          <div className="flex items-center gap-4">
            <div className="relative group">
              <button className="p-3 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl text-slate-400 dark:text-slate-500 hover:text-blue-600 dark:hover:text-blue-400 transition-all shadow-sm group-hover:-translate-y-1 group-hover:shadow-md">
                <Bell size={18} />
              </button>
            ...
            <button onClick={() => window.location.hash = '#/'} className="px-6 py-2.5 bg-slate-900 dark:bg-blue-600 text-white rounded-2xl text-[10px] font-black uppercase tracking-widest hover:bg-blue-600 dark:hover:bg-blue-500 transition-all flex items-center gap-2 shadow-lg shadow-slate-900/20 dark:shadow-blue-500/20 hover:-translate-y-1">
