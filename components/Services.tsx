    ...
    >
      ...
      <div className="container mx-auto px-6 max-w-7xl relative">
        ...
        <div className="flex flex-col items-center text-center mb-24 relative">
          ...
          <h2 className="text-4xl md:text-6xl lg:text-7xl font-black text-slate-900 leading-[0.9] tracking-[-0.05em] mb-8">
            <span className="text-rose-400 opacity-60 text-2xl md:text-3xl block mb-4 uppercase tracking-[0.2em] font-black">All Systems Verified</span>
            Everything for <br />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-44">
          {services.map((service, idx) => (
            <div 
              key={idx} 
              className={`group relative p-8 bg-white/90 backdrop-blur-md border ${service.borderColor} ${service.hoverBorder} rounded-[2.5rem] hover:bg-white hover:shadow-[0_50px_90px_-20px_rgba(0,0,0,0.12)] hover:-translate-y-3 transition-all duration-500 overflow-hidden cursor-pointer`}
            >
              ...
              <div className="relative z-10 flex flex-col h-full">
                ...
                <div className="flex items-center justify-between mb-4">
                  ...
                  <div className="flex items-center space-x-1.5">
                    ...
                    <span className="text-[10px] font-black text-slate-400 uppercase tracking-tighter">{service.stat}</span>
                  </div>
                </div>
                ...
                <div className="space-y-3 mt-auto">
                   {service.features.map(f => (
                     <div key={f} className="flex items-center space-x-3 text-[11px] font-black text-slate-400 uppercase tracking-widest group-hover:text-slate-600 transition-colors">
                ...
                <div className={`mt-10 pt-6 border-t border-slate-100 flex items-center justify-between opacity-50 group-hover:opacity-100 transition-all duration-500`}>
                   <span className={`text-[11px] font-black text-slate-900 uppercase tracking-wider`}>Protocol: Start</span>
                   <div className={`p-2 bg-${service.color}-50 rounded-xl group-hover:bg-slate-900 group-hover:text-white transition-colors`}>
           ...
           <div className="relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
              ...
              <div className="lg:col-span-5 text-left space-y-10">
                 ...
                 <div className="flex flex-wrap gap-4">
                    <button className="group relative bg-white text-slate-950 px-8 py-5 rounded-2xl font-black text-[11px] tracking-widest hover:scale-105 active:scale-95 transition-all shadow-xl uppercase flex items-center gap-3">
                      <span>Enter Hub</span>
